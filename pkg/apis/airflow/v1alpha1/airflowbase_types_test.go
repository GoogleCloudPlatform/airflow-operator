...
// EDIT THIS FILE!
// Created by "kubebuilder create resource" for you to implement the AirflowBase resource tests

var _ = Describe("AirflowBase", func() {
	var instance AirflowBase
	var expected AirflowBase
	var client AirflowBaseInterface

	BeforeEach(func() {
		instance = AirflowBase{}
