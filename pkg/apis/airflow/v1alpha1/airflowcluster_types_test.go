...
// EDIT THIS FILE!
// Created by "kubebuilder create resource" for you to implement the AirflowCluster resource tests

var _ = Describe("AirflowCluster", func() {
	var instance AirflowCluster
	var expected AirflowCluster
