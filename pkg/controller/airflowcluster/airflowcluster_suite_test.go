...
import (
	...
	"k8s.io/airflow-operator/pkg/inject"
...
func TestBee(t *testing.T) {
	...
	RunSpecsWithDefaultAndCustomReporters(t, "AirflowCluster Suite", []Reporter{test.NewlineReporter{}})
}
...
var _ = BeforeSuite(func() {
	...
	defer GinkgoRecover()
	Eventually(func() interface{} { return arguments.ControllerManager.GetController("AirflowClusterController") }).
		Should(Not(BeNil()))
	ctrl = arguments.ControllerManager.GetController("AirflowClusterController")
})
